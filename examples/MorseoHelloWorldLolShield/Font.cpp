...
/*
  ...
  History:
    ...
    2015-01-18 - added characters by Louis O'Callaghan
...
C(34) = { P(0,1), P(0,2), P(0,3), P(2,1), P(2,2), P(2,3), END };
C(39) = { P(1,3), P(2,1), P(2,2), END };
C(44) = { P(1,7), P(2,5), P(2,6), END };
C(45) = { P(0,4), P(1,4), P(2,4), P(3,4), END };
C(46) = { P(0,7), END };
C(47) = { P(0,7), P(1,5), P(2,3), P(3,1), END};
C(48) = { P(0,2), P(0,3), P(0,4), P(0,5), P(0,6), P(1,1), P(1,5), P(1,7), P(2,1), P(2,4), P(2,7), P(3,1), P(3,3), P(3,7), P(4,2), P(4,3), P(4,4), P(4,5), P(4,6), END };
...
C(58) = { P(0,2), P(0,6), END };
C(63) = { P(0,2), P(1,1), P(2,1), P(3,2), P(3,3), P(2,4), P(1,5), P(1,7), END }; // ?
C(64) = { P(0,2), P(0,3), P(0,4), P(0,5), P(0,6), P(1,1), P(1,3), P(1,4), P(1,7), P(2,1), P(2,2), P(2,5), P(2,7), P(3,2), P(3,3), P(3,4), P(3,5), END }; // @
...
C(92) = { P(0,1), P(1,3), P(2,5), P(3,7), END};
